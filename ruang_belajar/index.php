...
<html>
	<head>
		<title>RUANG BELAJAR || BAZIS KOTA ADMINISTRASI JAKARTA TIMUR</title>
		<link rel="shortcut icon" href="../asset/gambar/Logo.png" type="image/x-icon" />
		
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<!--[if lte IE 8]><script src="../asset/js/ie/html5shiv.js"></script><![endif]-->
		<link rel="stylesheet" href="../asset/css/mainsecond.css" />
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				<div id="main" style="background-image: url('../asset/gambar/latar.jpg');">
					...
					<div class="row">
							<section class="12u 12u(mobile)" align="center">
								<p align="justify">Ruang Belajar Bais merupakan suatu fasilitas yang diberikan Bazis Jakarta Utara kepada masyarakat luas guna untuk memberikan pandangan, pemahaman dan kesadaran kepada seluruh masyarakat apa itu ZIS (Zakat, Infak, dan Sodakoh) seberapa penting itu ZIS bagi diri sendiri dan masyarakat umum.</p>
							</section>
					</div>
