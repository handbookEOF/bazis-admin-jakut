				...
				<section class="container">
					...
					<div class="row">
						<section class="4u 12u(mobile)" align="center">
							<a href="albumfoto/?id_album_foto=<?php echo $data['id_album_foto']; ?>">
							<img src="../../album_foto/<?php echo $data['sampul_album_foto']; ?>" alt="" width="100%" height="150" style="border: 2px solid; border-radius: 10px 10px 10px 10px"/>
							</a>
							<a href="albumfoto/?id_album_foto=<?php echo $data['id_album_foto']; ?>" class="button">LIHAT ALBUM</a>
						</section>
						<section class="8u 12u(mobile)">
							<h3><a href="albumfoto/?id_album_foto=<?php echo $data['id_album_foto']; ?>"><?php echo $data['nama_album_foto']; ?></a></h3>
							<?php echo $data['tanggal_album_foto']; ?>
							<p align="justify"><?php echo $data['keterangan_album_foto']; ?></p>
						</section>
					</div>
					<?php
						}
