			...
			<!-- Main -->
				<div id="main" style="background-image: url('../asset/gambar/latar.jpg');">
					...
					<div class="row">
							...
							<img src="../album_anggota/<?php echo $data['foto_anggota'];?>" class="image full" height="300px">
							<table>
							...
							<a class="button" href="?use=<?php echo $user_anggota; ?>&perihal=indas">Info Dasar</a>
							<a class="button" href="?use=<?php echo $user_anggota; ?>&perihal=inpoi">Info Point</a>
							<a class="button" href="?use=<?php echo $user_anggota; ?>&perihal=rizis">Riwayat ZIS</a>
							<hr>
